...
const [data, setdata] = useState([]);
  ...
  const displayPosts = filteredData.slice(pageVisited, pageVisited + postPerPage);
    useEffect(()=>{
        dispatch(fetchpost())
    },[])
  ...
  return (
    ...
    //    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUm5Y6RI46TKJT1S-2j7xF71l5nuzYhUPz_vPbFDoIZFElY6Kq" 
      ...
      <Card.Body>
        ...
        <Button variant="primary"onClick={(e)=>dispatch(addcart(post))}>add to cart</Button>
      </Card.Body>
        </Card>
        </Col>
             ))
